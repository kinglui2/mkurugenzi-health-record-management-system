                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							?>
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Level List</div>
                                <div class="muted pull-right">
									Number of Level: <span class="badge badge-info"><?php echo $count; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_class1.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query1 = mysqli_query($conn,"select * from class")or die(mysqli_error());

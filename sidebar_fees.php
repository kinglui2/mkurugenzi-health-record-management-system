	...
	<center>
					...
					<li ><a href="dashboard.php"><i class="icon-chevron-right icon-large"></i><i class="icon-home icon-large"></i> Statistics</a></li>
						<li ><a href="students.php"><i class="icon-chevron-right icon-large"></i><i class="icon-group icon-large"></i> Patients</a></li>
						<li><a href="add_class.php"><i class="icon-chevron-right icon-large"></i><i class="icon-th-list icon-large"></i> Level</a></li>
						<li class="active"><a href="fees.php"><i class="icon-chevron-right icon-large"></i><i class="icon-money icon-large"></i> Bill Payment</a></li>

            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="">
                     <div class="row-fluid">
						...
						$cl = $row['class'];
						?>
						<div class="alert alert-success">PATIENT DETAILS</div>
						<div class="span6">
						...
						<div class="span5">
						Level: <strong><?php echo $row['class']; ?></strong><hr>
						<?php 
						...
						Level Category: <strong><?php echo $category; ?></strong><hr>
						Level Fee: <strong><?php echo $fee; ?></strong><hr>
